	...
	return(
		<div className="w-full h-fit text-sm sm:text-md">
			<div className="w-full flex flex-row items-center p-2 border-b border-zinc-600">
				<div className="px-2 p-1 bg-zinc-300/10 rounded hover:bg-zinc-200/20">
					{user ?
				...
				{user &&
				<button className="font-mono text-red-400/80 bg-red-500/5 px-2 p-1 hover:bg-red-400/20 focus:bg-red-400/40 rounded cursor-pointer"
